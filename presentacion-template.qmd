...
La desigualdad educativa persiste como una de las principales barreras para la **movilidad social en Chile**, especialmente en la Región Metropolitana de Santiago [[@Mineduc2023; @OECD2021]]{.small-text}. Esta asociación entre *origen social, trayectoria educativa y destino ocupacional* se ha documentado en estudios recientes que muestran una **movilidad intergeneracional limitada y fuertemente estratificada** por clase en el país, incluso entre las generaciones jóvenes [[@Muga_Mora2021-wb; @RodrigoOyarzo2021]]{.small-text}.

Aunque el acceso a la educación básica y media se ha expandido, las diferencias en años de escolaridad siguen reproduciendo clivajes de clase, género y territorio [[@AgenciaCalidadEducacion2015; @bellei2013estudio]]{.small-text}

------------------------------------------------------------------------

A raiz de lo anterior, el objetivo del estudio es analizar cómo la **interacción** entre recursos familiares (nivel socioeconómico, participación social) y **condiciones comunales** (tasa de empleo, oferta educativa, IDH) explica las diferencias en años de escolaridad en el Gran Santiago mediante un enfoque multinivel [[@FinchBolinKelley2019; @RomeroAlcarazHernandez2020]]{.small-text}
...
-   **Factores asociados L1:** Nivel socioeconómico del hogar [[@Arita2015]]{.small-text}, Género [[@PelaezRodriguez2020; @OECD2021]]{.small-text}y Participación social familiar [[@Bullones2022; @CanalesIbarrola2022Canales]]{.small-text}.
